        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none space-y-8 text-gray-700">
            <section>
              ...
              <p>
                Aisha Abdullahi Adamu ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, 
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-black mb-3 mt-4">Personal Data</h3>
              <p className="mb-4">
                Personally identifiable information, such as your name, email address, and telephone number, that you voluntarily give to us when 
                you register with the website or when you choose to participate in various activities related to the website.
              </p>

              <h3 className="text-xl font-semibold text-black mb-3 mt-4">Derivative Data</h3>
              <p className="mb-4">
                Information our servers automatically collect when you access the website, such as your IP address, browser type, operating system, 
                access times, and the pages you have viewed directly before and after accessing the website.
              </p>

              <h3 className="text-xl font-semibold text-black mb-3 mt-4">Financial Data</h3>
              <p className="mb-4">
                ...
                that we may collect when you purchase or order products or services.
              </p>
            </section>
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-black mb-3 mt-4">By Law or to Protect Rights</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-black mb-3 mt-4">Third-Party Service Providers</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-black mb-3 mt-4">Business Transfers</h3>
              <p className="mb-4">
            ...
            <section>
              ...
              <p>
                ...
                or regulatory reasons. We will notify you of any changes by posting the new Privacy Policy on this page and updating the "Last updated" date.
              </p>
            </section>
